...
public class AppendRedirectLsCommandTest {
    private AppendRedirectLsCommand command;
    ...
    public void setUp() throws IOException {
        command = new AppendRedirectLsCommand();
    ...
    @Test
    public void testAppendRedirectToFile() throws IOException {

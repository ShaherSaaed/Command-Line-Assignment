...
public class RedirectCatCommandTest {
    private RedirectCatCommand command;
    private Path tempDirectory;
    private File file1;
    private File file2;
    @BeforeEach
    public void setUp() throws IOException {
        command = new RedirectCatCommand();
        ...
        Files.writeString(file1.toPath(), "Hello, World2!");
    ...
    public void testAppendToExistingFile() throws IOException {
        ...
        assertEquals("Hello, World2!", file2Content.trim(), "file2.txt should contain content from file1");
    }
    @Test

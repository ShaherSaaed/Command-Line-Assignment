...
public class CLI {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            if (Arrays.asList(inputParts).contains("|")) {
                int index = Arrays.asList(inputParts).indexOf("|");
                String temp = inputParts[0];
                inputParts[0] = inputParts[index];
                inputParts[index] = temp;
            }
            ...
            switch (command) {
                ...
                case "touch":
                    ...
                    break;
                case "mv":
                    new MvCommand().execute(currentDirectory,commandArgs);
                    break;
                case "rm":
                ...
                case "cat":
                    ...
                    break;
                case "|":
                    new PipeCommand().execute(currentDirectory,commandArgs);
                    break;
                case "exit":
                    running = false;
                    break;
